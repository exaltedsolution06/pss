...
//import 'package:picturesourcesomerset/app/modules/shop_screen/views/detail_screen.dart';
...
class SerachScreenView extends StatelessWidget {
	...
	final commentController = Get.put(CommentController(Get.find<ApiService>())); // Ensure ApiService is already initialized
	final postController = Get.put(PostController(Get.find<ApiService>())); // Ensure ApiService is already initialized
  ...
  Widget build(BuildContext context) {
	...
	final double screenWidth = MediaQuery.of(context).size.width;
	  ...
	  List pic = [
		...
		List title = [
		  'Virat Kohli f dsgf dsfg sdfg sdfg sdfg dsfg sdfg sdfg dsfg',
		  'M.S. Dhoni',
		  'Alon musk',
		  'Popatlal',
		  'Khan Ali',
          ...
          bottom: PreferredSize(
            ...
            child: Column(
				children: [
							...
							children: [
								...
								autoWidthBtn(
									...
									onPress: () {
											...
											serachScreenController.loadInitialDataForTab(0);  // Trigger the top data search
										},
									),
							],
						),
					...
					Obx(() {
					  int selectedIndex = serachScreenController.selected.value;
					  return TabBar(
						onTap: (index) {
						  serachScreenController.onTabChange(index);
						},
        ...
        body: Obx(() {
          ...
          return TabBarView(
            children: [
              ...
              buildSearchList(serachScreenController.latestData),
              buildSearchList(serachScreenController.peopleData),
              buildSearchList(serachScreenController.photosData),
              buildSearchList(serachScreenController.videosData),
            ],
          );
        }),
      ),
								...
								child: Column(
									...
									children: [
										Obx(() => dropdownField(
											text1: 'Country', 
											width: screenWidth,
											value: serachScreenController.selectedCountry.value,
											items: ['USA', 'Canada', 'Mexico'],
											onChanged: (value) => serachScreenController.updateCountry(value!),
										)),
										Obx(() => dropdownField(
											text1: 'State / Province', 
											width: screenWidth,
											value: serachScreenController.selectedState.value,
											items: ['California', 'Texas', 'Florida'],
											onChanged: (value) => serachScreenController.updateState(value!),
										)),
										...
										Row(
											...
											children: [
											  Obx(() => Column(
												...
												children: [
												  Checkbox(
													value: serachScreenController.isChecked.value,
													onChanged: (bool? value) {
													  serachScreenController.toggleCheckbox(value!);
													},
												  ),
												],
											  )),
