...
class PrivacyPolicyScreenView extends GetView<RegisterController> {
...
@override
  Widget build(BuildContext context) {
    ...
    registerController.shouldFetchPrivacyPage = true;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(() => Text(
            registerController.privacyPolicyPageTitle.value,
      ...
      body: Obx(() {
        ...
        } else if (registerController.privacyPolicyPageTitle.value.isEmpty) {
                ...
                SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Last updated: ${registerController.privacyPolicyUpdatedDate.value}',
                        style: const TextStyle(
                          fontSize: 20,
                          color: AppColor.black,
                      ...
                      Html(
                        data: registerController.privacyPolicyPageContent.value,
                        style: {
